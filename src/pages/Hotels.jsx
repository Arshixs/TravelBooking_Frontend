...
const Hotels = () => {
  ...
  const renderStars = (value) => {
    ...
    const empty = 5 - full
    return (
      <span className="hotel-stars-large" aria-label={`Rating ${value} out of 5`}>
        {"★".repeat(full)}
        {"☆".repeat(empty)}
        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <p className="hero-subtitle">
              Explore handpicked accommodations with verified ratings, complete contact details, and transparent
              pricing. Your perfect stay is just a click away.
            </p>
      ...
      <section className="destinations-section">
        <div className="container">
          <div className="section-header">
            ...
            <p>Find the perfect accommodation with complete details and verified information</p>
          </div>
              ...
              <div className="search-wrapper">
                <div className="search-input-wrapper">
                  ...
                  <input
                    ...
                    onFocus={() => {
                      if (searchQuery.trim() && autocompleteSuggestions.length > 0) {
                        setShowSuggestions(true)
                      }
                    }}
                    onBlur={() => {
          ...
          <div className="hotels-modern-grid">
            {filteredHotels.map((hotel) => (
              <article key={hotel.hotel_id} className="hotel-modern-card" role="article" aria-label={hotel.name}>
                <div className="hotel-modern-card-header">
                  <div className="hotel-modern-card-image">
                    <img
                      src={hotel.image_url || "/placeholder.svg?height=200&width=350" || "/placeholder.svg"}
                      alt={`${hotel.name}`}
                      loading="lazy"
                    />
                    <div className="hotel-rating-overlay">{renderStars(hotel.rating)}</div>
                  </div>
                </div>
                  ...
                  <div className="hotel-modern-info">
                    <div className="hotel-info-row">
                      ...
                      <span className="hotel-info-text">
                        {[hotel.street, hotel.city, hotel.state, hotel.pin].filter(Boolean).join(", ")}
                      </span>
                    </div>
                    ...
                    {hotel.primary_email && (
                      <div className="hotel-info-row">
                        ...
                        <span className="hotel-info-text">{hotel.primary_email}</span>
                      </div>
                    )}
                    ...
                    {hotel.primary_phone && (
                      <div className="hotel-info-row">
                        ...
                        <span className="hotel-info-text">{hotel.primary_phone}</span>
                      </div>
                    )}
                    ...
                    <div className="hotel-info-row">
                      ...
                      <span className="hotel-info-text">{hotel.total_rooms} Rooms Available</span>
                    </div>
                  </div>

                  <button className="btn-view-hotel" type="button" onClick={() => handleViewDetails(hotel.hotel_id)}>
                    View Details
                  </button>
                </div>
              </article>
          ...
          {filteredHotels.length === 0 && !loading && (
            <div className="no-results">
              ...
              <p>
                No hotels found {selectedCity !== "All" ? `in ${selectedCity}` : ""}.{" "}
                {searchQuery && "Try a different city or "} Try selecting a different filter.
              </p>
            </div>
          )}
        </div>
      ...
      <section className="why-book-section">
        <div className="container">
          <div className="section-header">
            ...
            <p>Experience hassle-free hotel booking with complete transparency</p>
          </div>
          <div className="why-book-grid">
            <div className="why-book-card">
              ...
              <p>All ratings are from real guests who have stayed at our partner hotels</p>
            </div>
            <div className="why-book-card">
              <div className="why-book-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="why-book-card">
              ...
              <h3>24/7 Support</h3>
              <p>Our customer support team is always available to help with your booking</p>
            </div>
            <div className="why-book-card">
              <div className="why-book-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <p>We ensure you get the best rates available for your chosen hotel</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="cta-section">
        <div className="container">
          <div className="cta-content">
            ...
            <p>Browse our collection of premium hotels and find your ideal accommodation today.</p>
